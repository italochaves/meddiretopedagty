...
const PrintLayout: React.FC = () => {
    const { printQueue, patientName, activeLetterhead, setIsBackgroundLoaded } = usePrint();
            ...
            {printQueue.map((item, index) => (
                <div 
                    ...
                    style={{ 
                        ...
                        position: 'relative', // Importante para as camadas
                        overflow: 'hidden',
                        margin: '0',
                ...
                >
                    ...
                    {/* Usamos <img> com position absolute para garantir impressão cross-browser */}
                    {activeLetterhead && (
                        <img 
